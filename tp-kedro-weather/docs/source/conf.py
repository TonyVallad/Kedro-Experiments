...
# tp_kedro_weather documentation build
...
from tp_kedro_weather import __version__ as release

# -- Project information -----------------------------------------------------

project = "tp_kedro_weather"
author = "Kedro"
...
htmlhelp_basename = "tp_kedro_weatherdoc"
...
latex_documents = [
    (
        master_doc,
        "tp_kedro_weather.tex",
        "tp_kedro_weather Documentation",
        "Kedro",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "tp_kedro_weather",
        "Project tp_kedro_weather codebase.",
        "Data-Science",
    )
]
